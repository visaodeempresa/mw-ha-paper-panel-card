...
REPO = "visaodeempresa/mw-ha-paper-panel-card"          # dono/repositório no GitHub
NOME = "mw-ha-paper-panel-card"                    # a pasta em /config/www/community
CARD = "mw-paper-panel-card"                    # o arquivo .js, sem extensão
